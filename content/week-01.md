...
description: Google Drive, AI, Figma setup; introducing AI as a research and planning collaborator; course project scope and expectations.
---
...
- Shortlist of five e-commerce brands you'd consider redesigning, one sentence each on why

## Session plan

01. **Course intro & project reveal** — The studio project, the two-phase arc, and what the four final screens have to be.
02. **Figma setup** — Setup individual workspace - folder.
03. **AI setup** — Set up your Google AI tools (Gemini).
04. **Reference file walkthrough** — Open the RWD-Nespresso file and trace it backwards: final screens → design system → art direction → wireframes → research.
05. **Wrap & homework** — Brand selection and brand research.

## In-class activity: Brand selection workshop
...
1. **Brand selection and rationale**
  - Why did you select this brand?
  - What opportunities for improvement have you identified?
  - Conduct a SWOT analysis.
2. **Desk research: brand profile** — include the following:
  - Target audience
  - Brand archetype
  - Competitive landscape
  - Mission and vision
  - Competitor analysis: analyze at least three competitors within the same category. Identify what each competitor does well and where there may be opportunities for improvement.
3. **Live website audit** — audit the brand's current website, focusing only on:
  - Homepage
  - Product Detail Page (PDP)
4. **User interviews**
  - Conduct user interviews to identify users' pain points, needs, wants, and goals within the brand's category.

> **Due before class in Week 2.**
> - Upload all assignments to your group's Google Drive folder.
> - Also add the live website audit to FigJam for our in-class review.
